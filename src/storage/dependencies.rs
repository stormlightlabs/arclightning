...
use crate::domain::{DomainError, Task, TaskDependency, TaskId};
...
mod tests {
    ...
    use crate::domain::{DomainError, TaskAction, TaskPriority};

    fn graph() -> (Database, crate::domain::MilestoneId) {
    ...
    fn dependencies_validate_targets_uniqueness_and_transitive_cycles_atomically() {
        ...
        let missing = crate::domain::TaskId::new();
        assert!(matches!(
