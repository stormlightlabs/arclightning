...
<header class="site-header" data-pagefind-ignore>
  <div class="site-header__inner">
    <a class="brand" href="/" aria-label="Arc Lightning home"><span class="brand__mark" aria-hidden="true">ϟ</span><span>Arc Lightning</span></a>
    ...
    <div class="site-header__actions">
      ...
      <details class="mobile-menu">
        ...
        <div class="mobile-menu__panel">
          ...
          <div class="mobile-doc-links">{#each docs as doc}<a class:active={doc.slug === currentSlug} href={`/${doc.slug}/`}>{doc.title}</a>{/each}</div>
        </div>
      </details>
    </div>
  </div>
