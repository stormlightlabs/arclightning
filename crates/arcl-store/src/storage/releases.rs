...
use arcl_core::domain::{ContainerAction, ContainerStatus, DomainError, Release, ReleaseId};
...
pub fn update(
    ...
    if let Some(title) = &title {
        arcl_core::domain::validate_title(title).map_err(StorageError::InvalidRelease)?;
    }
